...
setup(
    ...
    install_requires=['requests>=2.26.0', 'beautifulsoup4>=4.10.0', 'rich>=10.10.0', 'Pillow>=8.3.1', 'lxml>=4.6.3','flask>=3.0.3','waitress>=3.0.0','gunicorn>=22.0.0','flask-cors>=4.0.1'],
    project_urls={
